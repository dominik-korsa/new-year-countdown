...
// update particle
Particle.prototype.update = function update(index) {
...
function loop() {
  ...
  // setting the composite operation to destination-out will allow us to clear the canvas
  // at a specific opacity, rather than wiping it entirely
  ...
  if (timerTick >= timerTotal) {
    ...
    // then set the random target coordinates,
...
// update firework
Firework.prototype.update = function update(index) {
  // remove last item in coordinates array
  this.coordinates.pop();
  // add current coordinates to the start of the array
  this.coordinates.unshift([this.x, this.y]);
...
// draw firework
Firework.prototype.draw = function draw() {
  ctx.beginPath();
